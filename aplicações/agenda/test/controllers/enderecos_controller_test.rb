...
class EnderecosControllerTest < ActionController::TestCase
  ...
  test "should create endereco" do
    assert_difference('Endereco.count') do
      post :create, endereco: { cidade: @endereco.cidade, endereco: @endereco.endereco, estado: @endereco.estado }
    end
  ...
  test "should update endereco" do
    patch :update, id: @endereco, endereco: { cidade: @endereco.cidade, endereco: @endereco.endereco, estado: @endereco.estado }
    assert_redirected_to endereco_path(assigns(:endereco))
  end
