class TiposController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @tipo.save
        format.html { redirect_to tipos_path, notice: I18n.t('message.created') }
  ...
  def update
    respond_to do |format|
      if @tipo.update(tipo_params)
        format.html { redirect_to tipos_path, notice: I18n.t('message.updated') }
  ...
  def destroy
    @tipo.destroy
    respond_to do |format|
      format.html { redirect_to tipos_url, notice: I18n.t('message.destroyed') }
