...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post phones_url, params: { phone: { customer_id: @phone.customer_id, ddd: @phone.ddd, number: @phone.number } }
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { customer_id: @phone.customer_id, ddd: @phone.ddd, number: @phone.number } }
